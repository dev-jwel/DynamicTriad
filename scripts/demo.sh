...
python . -I 10 -d data/academic_toy -n 15 -K 48 -l 4 -s 2 -o output --beta-smooth 1 --beta-triad 1 --cachefn /tmp/academic_toy -b 5000
#python . -I 10 -d data/academic_toy -n 15 -K 48 -l 1 -s 1 -o output --beta-smooth 1 --beta-triad 1 --cachefn /tmp/academic_toy -b 5000
...
python scripts/stdtests.py -f output -d data/academic_toy.pickle -m 1980 -s 4 -l 2 -n 15 -t all --datasetmod core.dataset.citation --cachefn /tmp/academic_toy_raw
