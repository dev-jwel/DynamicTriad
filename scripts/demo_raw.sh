...
python . -I 10 -d data/academic_toy.pickle -n 15 -K 48 -l 4 -s 2 -o output --beta-smooth 1 --beta-triad 1 --datasetmod core.dataset.citation -m 1980 --cachefn /tmp/academic_toy_raw -b 5000
